...
var signinForm = yo`
    <div class="col s12 m7">
            ...
            <div class="signup-box">
                ...
                <form class="signup-form">                    
                    <div class="section">
                        ...
                        <a class="btn btn-fb hide-on-med-and-up"> <i class="fa fa-facebook-official">${translate.message('signup.text')}</i></a>
                    </div>
        ...
        <div class="row">
            <div class="login-box">
                ¿No tienes una cuenta? <a href="/signup">${translate.message('signup.call-to-action')}</a>
            </div>
        </div>
    </div>`;
